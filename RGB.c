...
void SW_init(void){
	...
	GPIO_clock_gating( GPIO_B);	// PTB2_B1 PTB3_B2 PTB10_B3 PB11_B4
	GPIO_clock_gating( GPIO_C);	// sw2 PTC11_B5 PTC10_B6
	...
	GPIO_pin_control_register( GPIO_C, bit_11, &input_config );//B4	      - pin  11
	GPIO_pin_control_register( GPIO_C, bit_10, &input_config );//B5	      - pin  3
